...
if __name__ == '__main__':
	...
	for item in definitions.find():
		pprint.pprint(item)
	pprint.pprint(definitions.find_one())
	pprint.pprint(definitions.find_one({"word": "Capitaland"}))
	pprint.pprint(definitions.find_one({"_id": "56fe9e22bad6b23cde07b8cb"}))
	item = {"word": "pain", "definition": "online classes"}
	definitions.insert_one(item)
